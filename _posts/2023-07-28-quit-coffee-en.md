...
Sympathy and compassion must be granted by a total self-rupture to break those rigid patterns, layers, armours and so called "I think it is good for you" kinda authority so we could get close to our soul in order to fully feel other's soul in a equal position and be able to listen and echo back.
